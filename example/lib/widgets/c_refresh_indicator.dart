...
class RefreshIndicatorState extends State<CRefreshIndicator>
    with TickerProviderStateMixin<CRefreshIndicator> {
  ...
  @override
  void didUpdateWidget(covariant CRefreshIndicator oldWidget) {
